          ...
          <table class="table table-striped table-hover" id="ticketTable">
            ...
            <c:forEach var="ticket" items="${tickets}">
              <tr>
                ...
                <td>${ticket.user != null ? ticket.user.fullName : 'Không có dữ liệu'}</td>
                <td>${ticket.trip != null ? ticket.trip.tripId : 'Không có dữ liệu'}</td>
                <td>${ticket.seat != null ? ticket.seat.seatNumber : 'Không có dữ liệu'}</td>
