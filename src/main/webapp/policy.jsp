    ...
    <body>
        ...
        <section class="policy-section">
            <div class="container">
                ...
                <p>Chúng tôi cam kết cung cấp dịch vụ tốt nhất cho khách hàng. Vui lòng đọc kỹ các chính sách trước khi đặt vé.</p>
                <ul>
                    <li>Vé đã đặt không thể hoàn tiền, chỉ có thể đổi lịch trình.</li>
                    <li>Hành khách cần có mặt tại bến trước 30 phút để làm thủ tục.</li>
                    <li>Hành lý quá khổ có thể phải chịu thêm phí.</li>
                    <li>Mọi tranh chấp được giải quyết theo quy định pháp luật.</li>
                </ul>
            </div>
        </section>
