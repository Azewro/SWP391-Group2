                        ...
                        <tbody>
                            <c:forEach var="busTrip" items="${busTrips}">
                                <tr>
                                    ...
                                    <td>
                                        <a href="TripDetail?RouteId=${param.RouteId}&tripId=${busTrip.tripId}&driver=${busTrip.driver.userId}&busId=${busTrip.bus.busId}" class="btn btn-warning">Chọn Chuyến</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
