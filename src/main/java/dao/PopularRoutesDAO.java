...
public class PopularRoutesDAO {
    public List<Route> getPopularRoutes() throws SQLException {
        ...
        String query = "SELECT r.route_id, r.route_name, r.start_location_id, r.end_location_id, r.distance, r.estimated_duration, c.city_name AS start_city\n" +
"FROM Routes r\n" +
...
"LIMIT 3;";
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            while (rs.next()) {
                ...
                startLocation.setName(rs.getString("startLocation"));
                route.setStartLocation(startLocation);

                Location endLocation = new Location();
                endLocation.setName(rs.getString("endLocation"));
